    ...
    func loadMarkdownBlockDirectives() throws {
        ...
        try FileManagerPlayground {
            Directory("themes") {
                Directory("default") {
                    Directory("blocks") {
                        File("highlighted-text.yml", string: """
            ...
            #expect(
                result == [
                    .init(
                        ...
                        tag: "div",
                        attributes: [
                            MarkdownBlockDirective.Attribute(name: "class", value:"highlighted-text")
                        ],
                        output: nil
                    ),
                    .init(
                        name: "Button",
                        parameters: [
                            MarkdownBlockDirective.Parameter(label: "url", required: nil, default: ""),
                            MarkdownBlockDirective.Parameter(label: "class", required: nil, default: "button"),
                            MarkdownBlockDirective.Parameter(label: "target", required: nil, default: "_blank"),
                        ],
                        requiresParentDirective: nil,
                        removesChildParagraph: true,
                        tag: "a",
                        attributes: [
                            MarkdownBlockDirective.Attribute(name: "href", value: "{{url}}"),
                            MarkdownBlockDirective.Attribute(name: "target", value: "{{target}}"),
                            MarkdownBlockDirective.Attribute(name: "class", value: "{{class}}")
                        ],
                        output: nil
                    )
                ]
